...
bool CTradeVirtual::Buy(VirtualTradeInfo &vTrade, string pSymbol, double pVolume, 
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeVirtual::Sell(VirtualTradeInfo &vTrade, string pSymbol, double pVolume, 
                         double pStop, double pProfit, string pComment)
{
